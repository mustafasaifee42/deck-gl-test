...
const UpdateBoxData = (
  ...
  if (name !== 'GreyScale') {
    queue()
      .defer(json, `../data/BoxID_${boxID}/${name}.json`)
      .await(
        (
          ...
          >
            ...
            >
              <ChevronsLeft
                ...
                size={20}
              />
              <div>Back to Multi-Box View</div>
            </NavLink>
            <div
              style={{
                color: 'rgb(230, 237, 243)',
